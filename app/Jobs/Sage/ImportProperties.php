...
/** Imports master data (areas, properties, customers, services, tariffs) from the Sage property module. */
final class ImportProperties extends SageJob
{
    protected function execute(SageOperation $operation): array
    {
        $r = app(SageImportService::class)->run();
